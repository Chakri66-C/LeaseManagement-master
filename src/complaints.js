...
complaintsRouter.get('/api/getComplaints/:userId', async (req, res) => { // userid is route parameter
    const userId=req.params.userId; // ex: user id:12345 rom the url is stored in user id
    try {
